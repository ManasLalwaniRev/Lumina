// // lumina_pct/src/components/ViewPage.jsx
...
//           <p className="text-center text-gray-600">No entries found. Add some data!</p>
//         )}
...
//                       {entry.contractShortName}
//                     </td>
//                     <td className="px-6 py-4 whitespace-nowrap text-base text-gray-700">
//                       {entry.vendorName}
//                     </td>
//                     <td className="px-6 py-4 whitespace-nowrap text-base text-gray-700">
//                       {formatDateForDisplay(entry.chargeDate)}
//                     </td>
//                     <td className="px-6 py-4 whitespace-nowrap text-base text-gray-700">
//                       ${entry.chargeAmount ? parseFloat(entry.chargeAmount).toFixed(2) : '0.00'}
//                     </td>
//                     <td className="px-6 py-4 whitespace-nowrap text-base text-gray-700">
//                       {formatDateForDisplay(entry.submittedDate)}
//                     </td>
//                     <td className="px-6 py-4 whitespace-nowrap text-base text-gray-700">
//                       {entry.submitter}
//                     </td>
//                     <td className="px-6 py-4 whitespace-pre-wrap text-base text-gray-700">
//                       {entry.chargeCode}
//                     </td>
//                     <td className="px-6 py-4 whitespace-pre-wrap text-base text-gray-700">
//                       {entry.notes}
