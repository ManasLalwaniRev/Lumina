...
// // The API base URL is a placeholder for your backend.
...
// const AccountantPage = ({ setCurrentPage }) => {
//   const [dataEntries, setDataEntries] = useState([]);
//   const [filteredEntries, setFilteredEntries] = useState([]);
//   const [isLoading, setIsLoading] = useState(true);
//   const [error, setError] = useState(null);
  
//   // State to hold the filter values for each column.
...
//     notes: '',
//     pdfFilePath: '',
//     // New filter states for accountant-specific columns
//     accountingProcessed: '',
//     dateProcessed: '',
//     apvNumber: ''
//   });

//   // State to manage edited data for the new columns
...
//   // Handler for updating an editable field
...
//   // UPDATED: Handler for saving all changes at once
...
//         });
//         if (!response.ok) {
//           throw new Error(`Failed to save entry ID ${id}`);
//         }
...
//       // Reset the edited state after all saves are complete
//       setEditedData({});
...
//         {/* NEW: Save All button visible only when there are changes */}
...
//                   {/* New Accountant-specific columns */}
...
//                         ) : 'N/A'}
//                       </td>
//                       {/* Editable Columns for Accountant */}
...
// export default AccountantPage;
    ...
    // const API_BASE_URL = 'http://localhost:5000/api/entries'; 
    const API_BASE_URL = 'https://rev-lumina.onrender.com/api'; // Your live Render API URL
